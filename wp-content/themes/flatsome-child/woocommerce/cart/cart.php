...
<div class="col large-8 left-cart-page pb-0 <?php echo $main_classes; ?>">
...
<div class="cart-wrapper sm-touch-scroll">
						...
						<td class="product-remove">
							<?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove remove-cart" aria-label="%s" data-product_id="%s" data-product_sku="%s"><span class="lnr lnr-trash"></span></a>',
	...
	<a href="<?php home_url()?>/shop" class="style-button2"><span class="lnr lnr-plus-circle" style="padding-right:5px;"></span> Mua thêm </a>
...
<div class="cart-collaterals right-cart-page large-4 col pb-0">
	...
	<div class="cart-sidebar col-inner <?php echo $sidebar_classes; ?>">
		...
		<form class="checkout_coupon mb-0" method="post">
			<div class="coupon">
				<h3 class="widget-title"><?php echo get_flatsome_icon( 'icon-tag' ); ?> <?php esc_html_e( 'Coupon', 'woocommerce' ); ?></h3><input type="text" name="coupon_code" class="input-text " id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> 
				<input type="submit" class="is-form expand style-button2" name="apply_coupon" value="<?php esc_attr_e( 'Áp dụng', 'woocommerce' ); ?>" />
